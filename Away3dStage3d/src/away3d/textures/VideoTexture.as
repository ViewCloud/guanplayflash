package away3d.textures
{
	...
	public class VideoTexture extends BitmapTexture
	{
		...
		public function VideoTexture(materialWidth:uint = 256, materialHeight:uint = 256, loop:Boolean = true, autoPlay:Boolean = false, player:IVideoPlayer = null)
		{
			...
			_player = player;
			_player.loop = loop;
			//colowap_player.width = _materialWidth;
			//colowap_player.height = _materialHeight;
		...
		public function set materialHeight(value:uint):void
		{
			...
			//colowap_player.width = _materialHeight;
