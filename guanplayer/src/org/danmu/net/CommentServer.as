package org.danmu.net
{
    ...
    import org.danmu.utils.CommentXMLConfig;
    ...
    **/
    public class CommentServer extends EventDispatcher
    {
        ...
        {
            log('remotePutHandler:'+com.adobe.serialization.json.JSON.encode(result));
        }
        ...
        {
            log('remoteError:'+com.adobe.serialization.json.JSON.encode(e));
        }
