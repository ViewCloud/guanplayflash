package org.danmu.utils
{
    ...
    public class CommentConfig extends EventDispatcher
    {
        ...
        public var filtersArr:Array = new Array();
       
        private var _font:String='黑体';
     
        /** 速度zjr因子:0.1-2 **/
        public var speede:Number = 0.1;
...
//            var han:RegExp = /[一-龥]/;
        ...
        override public function toString():String
        {
            ...
            return com.adobe.serialization.json.JSON.encode(a);
        }
        ...
        public function fromString(source:String):void
        {
            try
            {
                var a:Array = com.adobe.serialization.json.JSON.decode(source,false) as Array;
                bold = a[0];
                alpha = a[1];
                filterIndex = a[2];
                speede = a[3];
