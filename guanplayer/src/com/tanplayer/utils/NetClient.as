...
package com.tanplayer.utils {
	...
	public dynamic class NetClient {
		...
		private function forward(dat:Object, typ:String):void 
		{
			...
			trace("通过这里获取每段总长"+out['duration']);
			//通过这里获取每段总长
			//分段
			//RootReference.flashvarObject['duanTime'] = out['duration'];
		...
		public function onMetaData(obj:Object):void 
		{
			...
			flvduration= obj.duration;
			trace("metadata：::"+flvduration);   
