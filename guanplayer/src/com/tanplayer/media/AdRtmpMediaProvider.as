...
package com.tanplayer.media 
{
	 ...
	 **/
	public class AdRtmpMediaProvider extends MediaProvider 
	{
		...
		public function AdRtmpMediaProvider() {
			super('rtmp');
		}
		...
		private function finishLoad():void 
		{
			...
			sendVideoLoadMediaEvent(MediaEvent.LOADEDJWPLAYER_MEDIA,null,"ad");
			//trace(item.streamer);
