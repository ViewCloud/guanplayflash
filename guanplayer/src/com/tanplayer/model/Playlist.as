package com.tanplayer.model {
	...
	import com.tanplayer.parsers.IPlaylistParser;
	import com.tanplayer.parsers.JWParser;
	import com.tanplayer.parsers.ParserFactory;
	 ...
	 */
	[Event(name="jwplayerPlaylistLoaded", type="com.tanplayer.events.PlaylistEvent")]
	 ...
	 */
	[Event(name="jwplayerPlaylistUpdated", type="com.tanplayer.events.PlaylistEvent")]
	 ...
	 */
	[Event(name="jwplayerPlaylistItem", type="com.tanplayer.events.PlaylistEvent")]
	...
	public class Playlist extends GlobalEventDispatcher implements IPlaylist 
	{
		 ...
		 * @inheritDoc
		 */
		public function load(newPlaylist:Object):void //加载播放URL load
		{
			...
			} else if (newPlaylist is PlaylistItem) 
			{
				...
				if (JWParser.getProvider(pli)) //类型正确
				{
					newList.push(pli);
				} 
				else 
